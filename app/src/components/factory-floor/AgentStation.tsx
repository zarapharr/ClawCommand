...
export function AgentStation({ agent, isSelected, onClick, onDoubleClick }: AgentStationProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 -right-1 w-2 h-2 -translate-y-1/2 rounded-full bg-cyan-500/50" />
